...
WebUiBuiltInKeywords.click(findTestObject('Page_Select Client - Payroll Relief/div_SZ Star Restaurant Inc szt-2'))
...
WebUI.selectOptionByIndex(findTestObject('Page_EmployeeContractor Setup - Pay/dropdown_filing Status'), '3')
